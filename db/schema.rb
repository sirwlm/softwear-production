...
ActiveRecord::Schema.define(version: 20160620182116) do
  ...
  create_table "imprint_team_members", force: :cascade do |t|
    t.integer  "imprint_object_id",   limit: 4
    t.string   "imprint_object_type", limit: 191
    t.integer  "user_id",             limit: 4
