...
feature 'Transfer Prints', transfer_print: true, js: true do
  ...
  context 'as an admin' do
    ...
    scenario 'I can create an order with a transfer print' do
      create_order(
          name: 'Test Order',
          jobs: [
              {
      ...
      expect(page).to have_css('dd', text: 'Transfer print')
    end

    context 'given an order with an imprint that is a transfer print'  do
      given(:order) { create(:order, jobs: [ create(:job_with_transfer_print) ]) }
