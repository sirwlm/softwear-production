...
feature 'Embroidery Prints', embroidery_print: true, js: true do
  ...
  context 'as an admin' do
    ...
    scenario 'I can create an order with a embroidery print' do
      create_order(
          name: 'Test Order',
          jobs: [
              {
      ...
      expect(page).to have_css('dd', text: 'Embroidery print')
    end

    context 'given an order with an imprint that is a embroidery print'  do
      given(:order) { create(:order, jobs: [ create(:job_with_embroidery_print) ]) }
